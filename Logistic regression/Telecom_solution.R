...
# Loading 3 files
churn_data<- read.csv("C:\\Users\\212488767\\Desktop\\Data Science training\\IIITB\\Logistic regression\\churn_data.csv", stringsAsFactors = F)
customer_data<- read.csv("C:\\Users\\212488767\\Desktop\\Data Science training\\IIITB\\Logistic regression\\customer_data.csv", stringsAsFactors = F)
internet_data<- read.csv("C:\\Users\\212488767\\Desktop\\Data Science training\\IIITB\\Logistic regression\\internet_data.csv", stringsAsFactors = F)
