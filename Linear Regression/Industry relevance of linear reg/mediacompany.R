...
media <- read.csv("C:\\Users\\212488767\\Desktop\\Data Science training\\IIITB\\Linear Regression\\Industry relevance of linear reg\\mediacompany.csv", stringsAsFactors =FALSE)
View(media)
str(media)
