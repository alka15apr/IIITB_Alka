...
#Character/String variables cannot be combined using binary operators. There are specific functions like paste() used to combine/concatenate strings.
#The paste() function, by default would add a space as a separator until it is specified. paste("Hero", "Hiralal") , is actually taken by R as paste("Hero", "Hiralal", sep=" ")
# R by default stores character/string values as factors. Factor variables cannot be replaced by numeric or character variables.
#Introduction to R
...
#Lists
setwd("C:/Users/212488767/Desktop/Data Science training/IIITB/Intro To R")
