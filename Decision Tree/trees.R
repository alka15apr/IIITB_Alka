...
income <- read.csv("C:/Users/212488767/Desktop/Data Science training/IIITB/Tree Models/Decision Tree/adult_dataset.csv")
str(income)
View(income)
...
# evaluate the results
confusionMatrix(test$income, tree.predict, positive = ">50K")  # 0.77740
...
# evaluate the results
confusionMatrix(test$income, tree.predict, positive = ">50K") 
